        ...
        <div class="card p-4 h-80">
            ...
            <div class="row form-group justify-content-between">
                ...
                <div class="row col-sm-12 col-md-6 col-lg-7">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        <input type="text" disabled class="form-control form-control-sm" id="apellidos" value="<?php echo ($paciente->getApellidos()) ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row form-group justify-content-between">
                <div class="row col-sm-12 col-md-6 col-lg-5">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <input type="text" disabled class="form-control form-control-sm" id="genero" value="<?php echo ($paciente->getGenero() == 'H' ? 'Hombre' : 'Mujer') ?>">
                    </div>
                </div>
                ...
                <div class="row col-sm-12 col-md-6 col-lg-7">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        <input type="text" disabled class="form-control form-control-sm" id="lugarNacimiento" value="<?php echo ($paciente->getLugarNacimiento()) ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row form-group justify-content-between">
                <div class="row col-sm-12 col-md-6 col-lg-5">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <input type="text" disabled class="form-control form-control-sm" id="fechaNacimiento" value="<?php echo (date("d/m/Y", strtotime($paciente->getFechaNacimiento()))) ?>">
                    </div>
                </div>
                ...
                <div class="row col-sm-12 col-md-6 col-lg-7">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        <input type="text" disabled class="form-control form-control-sm" id="nacionalidad" value="<?php echo ($paciente->getNacionalidad()) ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row form-group justify-content-between">
                <div class="row col-sm-12 col-md-6 col-lg-5">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <input type="text" disabled class="form-control form-control-sm" id="tipoResidencia" value="<?php echo ($paciente->getTipoResidencia()) ?>">
                    </div>
                </div>
                <div class="row col-sm-12 col-md-6 col-lg-7">
                    <label for="residenciaActual" class="form-label col-form-label-sm col-sm-12 col-md-12 col-lg-4">Residencia actual</label>
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        <input type="text" disabled class="form-control form-control-sm" id="residenciaActual" value="<?php echo ($paciente->getResidenciaActual()) ?>">
                    </div>
                </div>
            </div>
