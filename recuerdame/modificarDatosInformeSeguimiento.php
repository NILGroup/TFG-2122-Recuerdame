    ...
    <div class="container-fluid">
        <?php
            if (!empty($_GET['idInforme'])) {
                ...
                $informeSeguimiento->setFecha(date('Y-m-d'));
            }
        ?>
        ...
        <form action="gestor.php?idInforme=<?php echo ($informeSeguimiento->getIdEvaluacion()) ?>" method="POST">
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 col-md-6 col-lg-2">
                        <input type="date" class="form-control form-control-sm" id="gds_fecha" name="gds_fecha" value="<?php echo ($informeSeguimiento->getFechaGds()) ?>">
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-9 col-md-6 col-lg-2">
                        <input type="date" class="form-control form-control-sm" id="mental_fecha" name="mental_fecha" value="<?php echo ($informeSeguimiento->getFechaMental()) ?>">
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-9 col-md-6 col-lg-2">
                        <input type="date" class="form-control form-control-sm" id="cdr_fecha" name="cdr_fecha" value="<?php echo ($informeSeguimiento->getFechaCdr()) ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-9 col-md-6 col-lg-2">
                         <input type="text" class="form-control form-control-sm" id="nombre_escala" name="nombre_escala" value="<?php echo ($informeSeguimiento->getNombreEscala()) ?>">
                    </div>
                    <div class="col-sm-9 col-md-6 col-lg-2">
                         <input type="number" class="form-control form-control-sm" id="escala" name="escala" value="<?php echo ($informeSeguimiento->getEscala()) ?>">
                    </div>
                    <div class="col-sm-9 col-md-6 col-lg-2">
                        <input type="date" class="form-control form-control-sm" id="fecha_esacala" name="fecha_escala" value="<?php echo ($informeSeguimiento->getFechaEscala()) ?>">
                    </div>
                </div>
