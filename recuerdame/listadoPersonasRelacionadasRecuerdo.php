                        ...
                        ?>
                            <tr>
                                ...
                                <td class="tableActions">
                                    <input class="form-check-input" type="checkbox" value="<?php echo ($row['idPersonaRelacionada']) ?>" name="checkPersonaRelacionada[]" id="checkPersonaRelacionada<?php echo ($row['idPersonaRelacionada']) ?>" <?php if (isset($row['id_recuerdo']) && $row['id_recuerdo'] != null) echo 'checked="checked" '; ?>>
                                </td>
                            </tr>
                        <?php
                            $i++;
