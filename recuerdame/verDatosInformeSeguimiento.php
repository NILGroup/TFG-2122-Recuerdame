...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            <a href="generarPDFInformeSeguimiento.php?idInforme=<?php echo ($informeSeguimiento->getIdEvaluacion()) ?>"><button type="button" class="btn btn-outline-primary btn-sm">Generar PDF</button></a>
