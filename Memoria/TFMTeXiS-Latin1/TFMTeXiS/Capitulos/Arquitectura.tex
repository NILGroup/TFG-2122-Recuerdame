...
Por las necesidades del proyecto y tras un estudio cerciorado, decidimos que la mejor forma de guardar la base de datos de nuestra aplicación sería MySQL. Por varias razones:
\begin{itemize}
