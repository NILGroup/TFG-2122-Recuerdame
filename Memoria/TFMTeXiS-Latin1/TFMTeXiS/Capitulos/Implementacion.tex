...
\begin{figure}[!ht]
  	\centering
  	\includegraphics[width=8cm]{./Imagenes/Figuras/implementacion/listado.png}
  	\caption{Pantalla del listado de usuarios.}
	\label{fig:listado}
\end{figure}
...
El botón de modificar a su vez lo podemos encontrar en todas las listas con el icono de un lápiz, como podemos observar en la Figura \ref{fig:modificar}. Para poder hacer uso de él clicaríamos en él y posteriormente la aplicación nos llevaría a la página de edición en la que una vez hayamos seleccionado el botón guardar, mandará una orden a la base de datos para que ésta sea modificada. Posteriormente una vez volvamos a acceder a aquella lista que modificada, podremos observar que se ha hecho el cambio. 
\begin{figure}[!ht]
  	\centering
  	\includegraphics[width=8cm]{./Imagenes/Figuras/implementacion/modificar.png}
  	\caption{Botón de modificación.}
	\label{fig:modificar}
\end{figure}

\subsection{Generar Libro de vida y PDF}
Una ver que queramos generar un libro de vida o de PDF del paciente seleccionamos en una de ambas opciones donde se recogerá la información de la base de datos para posteriormente mostrarla en forma de libro de vida \ref{fig:libroDeVida} o de PDF \ref{fig:pdf}, ambos recogerán la misma información sin embargo, su presentación es lo que las distingue.
\begin{figure}[!ht]
  	\centering
  	\includegraphics[width=8cm]{./Imagenes/Figuras/implementacion/libroDeVida.png}
...
\begin{figure}[!ht]
  	\centering
  	\includegraphics[width=8cm]{./Imagenes/Figuras/implementacion/pdf.png}
  	\caption{Generar PDF.}
	\label{fig:pdf.png}
\end{figure}
...
\begin{figure}[!ht]
  	\centering
  	\includegraphics[width=8cm]{./Imagenes/Figuras/implementacion/logout.png}
