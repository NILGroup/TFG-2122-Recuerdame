...
En la aplicación se pueden encontrar los siguientes formularios para crear nuevos registros: nuevo paciente, nueva sesión, nueva informe de seguimiento, nuevo informe de sesión, nuevo recuerdo y una persona relacionada. A continuación se muestra la pantalla de uno de ellos (ver Figura \ref{fig:anadir}) el diagrama de secuencia de un de ellos que sirve como ejemplo de lo que hacen todos los listado de la aplicación.
\begin{figure}[!ht]
  	\centering
...
A continuación se muestra el libro de Historia de Vida (ver Figura \ref{fig:libroDeVida}) el diagrama de secuencia.
\begin{figure}[!ht]
  	\centering
...
A continuación se muestra el PDF de Historia de Vida (ver Figura \ref{fig:pdf}) el diagrama de secuencia. 
\begin{figure}[!ht]
  	\centering
...
A continuación se muestra la lista de personas relacionadas asignadas a un recuerdo (ver Figura \ref{fig:anadirExistente.png}) y el diagrama de secuencia. 
\begin{figure}[!ht]
  	\centering
...
A continuación se muestra la pantalla de creación del informe de sesión (ver Figura \ref{fig:anadirInformeSesion}) y el diagrama de secuencia de un de ellos que sirve como ejemplo de lo que hacen todos los listado de la aplicación.
\begin{figure}[!ht]
  	\centering
...
El front hace una petición al modelo actividad que recupera el listado de actividades del paciente y el front las añade en el calendario.
\begin{figure}[!ht]
  	\centering
...
\subsection{Crear nueva actividad}
Mediante el formulario nueva actividad el usuario genera una petición mediante el botón Registrar que recupera el gestor y hace una llamada a la función guardarActividad(actividad) del Controlador CalendarioControlador que guarda la actividad haciendo una petición al modelo Actividad y con la función guardarActividad(actividad).
\begin{figure}[!ht]
  	\centering
  	\includegraphics[width=15cm]{./Imagenes/Figuras/implementacion/anadirActividad.png}
  	\caption{Crear nueva actividad.}
	\label{fig:anadirAcitvidad}
\end{figure}

\subsection{Modificar una actividad}
El usuario muestra una actividad del calendario y modifica sus datos mediante el botón Modificar. El gestor hace una llamada a la función guardarActividad(actividad) del Controlador CalendarioControlador que guarda la actividad haciendo una petición al modelo Actividad y con la función guardarActividad(actividad).
\begin{figure}[!ht]
  	\centering
  	\includegraphics[width=15cm]{./Imagenes/Figuras/implementacion/modificarActividad.png}
  	\caption{Modificar actividad.}
	\label{fig:modificarActividad}
\end{figure}

\subsection{Eliminar una actividad}
El usuario muestra una actividad del calendario y mediante el botón Eliminar actividad hace una llamada al gestor que hace una petición al Controlador CalendarioController que mediante la función eliminarActivida(idActividad) eliminar la activad llamando al modelo Actividad.
...
A continuación se muestra la pantalla de registro de un terapeuta (ver Figura \ref{fig:registroTerapeuta}) y el diagrama de secuencia.
\begin{figure}[!ht]
  	\centering
...
\subsection{Logout}
Se encuentra en la parte superior derecha de la pantalla y permite al usuario salir de la aplicación. Este botón lo podemos ubicar fácilmente en la siguiente Figura \ref{fig:logout}. Y le correspondería el siguiente diagrama de secuencia
\begin{figure}[!ht]
  	\centering
